...
export const EditClientModal = ({ isOpen, onClose, onSave, client }: EditClientModalProps) => {
    ...
    useEffect(() => {
        if (client) {
            ...
            setLastContact(client.lastContact ? new Date(client.lastContact) : null)
        }
    }, [client])
                ...
                <>
                    ...
                    >
                        ...
                        <div className="modal-client-header">
                            <h2 className="modal-client-title">Edit client details.</h2>
                            <p className="modal-client-subtitle">Update information for this relationship.</p>
                        </div>
